<div class="row" id="makeup_div">Select what kind of search to use
    ...
    <form action="/makeup" method="GET" name="makeup_form" class="makeup_form">
        <!-- <div class="" id="makeup_div">
            ...
            <select class="form-group dropdown form-control w-25 inline-block" name="product_type" id="makeup_type">
            ...
            <select class="form-group dropdown form-control w-25 inline-block "  name="brand" id="makeup_type">
